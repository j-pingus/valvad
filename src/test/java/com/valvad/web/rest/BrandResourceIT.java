...
class BrandResourceIT {
     ...
     *
     * @see com.valvad.repository.search.BrandSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void searchBrand() throws Exception {
        ...
        // Initialize the database
        brandRepository.saveAndFlush(brand);
        when(mockBrandSearchRepository.search("id:" + brand.getId())).thenReturn(Stream.of(brand));
