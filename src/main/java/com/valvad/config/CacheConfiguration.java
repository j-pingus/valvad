...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.valvad.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.valvad.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.valvad.domain.Compatibility.class.getName() + ".parts");
            createCache(cm, com.valvad.domain.Compatibility.class.getName() + ".models");
