...
public class Part implements Serializable {
    ...
    public void setCompatibilities(Set<Compatibility> compatibilities) {
        if (this.compatibilities != null) {
            this.compatibilities.forEach(i -> i.setPart(null));
        }
        if (compatibilities != null) {
            compatibilities.forEach(i -> i.setPart(this));
        }
        this.compatibilities = compatibilities;
    }

    public Part compatibilities(Set<Compatibility> compatibilities) {
        this.setCompatibilities(compatibilities);
        return this;
    }

    public Part addCompatibility(Compatibility compatibility) {
        this.compatibilities.add(compatibility);
        compatibility.setPart(this);
        return this;
    }

    public Part removeCompatibility(Compatibility compatibility) {
        this.compatibilities.remove(compatibility);
        compatibility.setPart(null);
        return this;
    }
