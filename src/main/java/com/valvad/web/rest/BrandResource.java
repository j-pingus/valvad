...
import com.valvad.repository.BrandRepository;
import com.valvad.repository.search.BrandSearchRepository;
...
/**
 * REST controller for managing {@link com.valvad.domain.Brand}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BrandResource {
    ...
    public List<Brand> searchBrands(@RequestParam String query) {
        ...
        return StreamSupport.stream(brandSearchRepository.search(query).spliterator(), false).collect(Collectors.toList());
    }
}
