...
import com.valvad.repository.ProfileRepository;
import com.valvad.repository.search.ProfileSearchRepository;
...
/**
 * REST controller for managing {@link com.valvad.domain.Profile}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ProfileResource {
    ...
    public List<Profile> searchProfiles(@RequestParam String query) {
        ...
        return StreamSupport.stream(profileSearchRepository.search(query).spliterator(), false).collect(Collectors.toList());
    }
}
