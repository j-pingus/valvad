...
export class AdService {
  ...
  update(ad: IAd): Observable<EntityResponseType> {
    return this.http.put<IAd>(`${this.resourceUrl}/${getAdIdentifier(ad) as number}`, ad, { observe: 'response' });
  }

  partialUpdate(ad: IAd): Observable<EntityResponseType> {
    return this.http.patch<IAd>(`${this.resourceUrl}/${getAdIdentifier(ad) as number}`, ad, { observe: 'response' });
  }
